      ...
      <div className="Inicio">
        ...
        >
          <div className="popupS-content">
            <button className="closeButton" onClick={() => closeModalSign()}>
              X
            </button>
            ...
            <div className="texto">
              ...
              <input
                ...
                value={contRep}
                onChange={(e) => setContRep(e.target.value)}
              />
        ...
        <header className="Inicio-header">OCA LOCA</header>
        <div className="body">Carrera hacia la meta</div>
        ...
        >
          <div className="popup-content">
            ...
            <p className="textoEspecifico" onClick={() => closeOpenModales()}>
              Regístrate
            </p>
            <div className="abc">
